...
fun BusScheduleApp(
    ...
    // Aplicar un fondo de color al Scaffold
    Scaffold(
        topBar = {
        ...
        // Establecer un fondo de color para toda la pantalla
...
fun BusScheduleScreen(
    ...
    Column(
        ...
        Row(
            ...
            Text(stopNameText,color = Color.White // Cambiar el color del texto a negro
            )
            Text(stringResource(R.string.arrival_time), color = Color.White)
        }
        Divider()
        BusScheduleDetails(
